...
import com.example.finapp.network.makePayment
...
fun PaymentScreen(navController: NavHostController ) {
    ...
    val amount = "50" // Hardcoded amount
        ...
        bottomBar = {
            BottomAppBar(
                ...
                IconButton(onClick = { /* Handle Twitter */ }) {
                    Icon(imageVector = Icons.Filled.Email, contentDescription = "Email", tint = Color.White)
                }
                // LinkedIn Icon
                IconButton(onClick = { /* Handle LinkedIn */ }) {
                    Icon(imageVector = Icons.Filled.FavoriteBorder, contentDescription = "FavoriteBorder", tint = Color.White)
                }
            }
        }
        ,
                ...
                Button(
                    onClick = {
                        if (phoneNumber.isNotEmpty()) {
                            // Call the payment function with the hardcoded amount
